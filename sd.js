...
async function sessdl() {
  try {
    ...
    const base64Data = sess.SESSION_ID.split("SD-MD~")[1];
    if (!base64Data) {
...
async function connectToWA() {
  ...
  //===========================
  console.log("🔥 SD-MD WA BOT is starting...");
  ...
  conn.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      let up = `
          🚀 ** SD-MD WA BOT Connected Successfully!** ✅ 
          
          --- Welcome to SD-MD WA BOT ---
          
          ~ Version : ${require("./package.json").version}
          ~ Platform : ${os.platform()}
          ~ Host : ${os.hostname()}
          ~ Owner: ${config.BOT_NUMBER}
       ...
       ~ **PREFIX:** ${config.PREFIX}
          ...
          --- Thank you for using SD-MD WA BOT. 
      ...
      conn.sendMessage(conn.user.id, {
        text: up,
        contextInfo: {
          mentionedJid: ["94766680279@s.whatsapp.net"], // specify mentioned JID(s) if any
          groupMentions: [],
          forwardingScore: 999,
          isForwarded: true,
          forwardedNewsletterMessageInfo: {
            newsletterJid: "120363299978149557@newsletter",
            newsletterName: " SD-MD WA BOT",
            serverMessageId: 999,
          },
          externalAdReply: {
            title: "SD-MD WA BOT",
            body: "S4DEW The Scoder",
            mediaType: 1,
            sourceUrl: "https://github.com/Sadew-The-Scoder/SD-MD-WHATSAPP-BOT",
            thumbnailUrl:
              "https://raw.githubusercontent.com/Sadew-The-Scoder/SD-MD-WHATSAPP-BOT/refs/heads/main/.media/Screenshot_20251123_015839.jpg", // This should match the image URL provided above
...
if (!app) return;
app.get("/", (req, res) => {
  res.send("hey I am alive, SD-MD WA BOT Is started✅");
});
app.listen(port, () =>
